        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                        ...
                        if (musician.location != null)
                          Row(
                            children: [
                              ...
                              Text(musician.location!, style: const TextStyle(fontSize: 12, color: AppColors.textSecondary)),
                            ],
                          ),
                      ],
                    ),
              ...
              StarRatingDisplay(rating: musician.avgRating, reviewCount: musician.reviewCount, size: 14),
              const SizedBox(height: 10),
              Wrap(
                spacing: 6,
                runSpacing: 6,
                children: musician.skills.take(3).map((s) => Chip(
              ...
              Row(
                ...
                children: [
                  if (musician.startingPrice != null)
                    Text('From \$${musician.startingPrice!.toStringAsFixed(0)}',
                        style: const TextStyle(fontWeight: FontWeight.w700, color: AppColors.textPrimary))
                  else
                    const Text('Price on request', style: TextStyle(color: AppColors.textSecondary, fontSize: 12)),
                  TextButton(
